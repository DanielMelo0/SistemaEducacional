...
public class Disciplina {
	...
	@Override
	public int hashCode() {
		return Objects.hash(disciplina1, disciplina2, disciplina3, disciplina4, Double.valueOf(nota1),
				Double.valueOf(nota2), Double.valueOf(nota3), Double.valueOf(nota4));
	}
